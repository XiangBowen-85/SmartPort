...
public class Tab2Controlador extends Fragment {
    private static final String TAG = "Tab2Controlador";
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        View view = inflater.inflate(R.layout.tab2_controlador, container, false);
